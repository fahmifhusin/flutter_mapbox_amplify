...
class Todo extends amplify_core.Model {
  ...
  const Todo._internal({required this.id, required userId, required locationName, mapboxData, createdAt, updatedAt}): _userId = userId, _locationName = locationName, _mapboxData = mapboxData, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Todo({String? id, required String userId, required String locationName, String? mapboxData}) {
  ...
  String toString() {
    ...
    buffer.write("mapboxData=" + "$_mapboxData" + ", ");
  ...
  Todo copyWith({String? userId, String? locationName, String? mapboxData}) {
    return Todo._internal(
      id: id,
      userId: userId ?? this.userId,
      locationName: locationName ?? this.locationName,
      mapboxData: mapboxData ?? this.mapboxData);
  }
  
  Todo copyWithModelFieldValues({
    ModelFieldValue<String>? userId,
    ModelFieldValue<String>? locationName,
    ModelFieldValue<String?>? mapboxData
  }) {
    return Todo._internal(
      id: id,
      userId: userId == null ? this.userId : userId.value,
      locationName: locationName == null ? this.locationName : locationName.value,
      mapboxData: mapboxData == null ? this.mapboxData : mapboxData.value
    );
  }
  ...
  Todo.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
      ...
      _mapboxData = json['mapboxData'],
      _createdAt = json['createdAt'] != null ? amplify_core.TemporalDateTime.fromString(json['createdAt']) : null,
      _updatedAt = json['updatedAt'] != null ? amplify_core.TemporalDateTime.fromString(json['updatedAt']) : null;
  
  Map<String, dynamic> toJson() => {
    'id': id, 'userId': _userId, 'locationName': _locationName, 'mapboxData': _mapboxData, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  ...
  static final MAPBOXDATA = amplify_core.QueryField(fieldName: "mapboxData");
